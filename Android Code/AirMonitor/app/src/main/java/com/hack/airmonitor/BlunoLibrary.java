...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
    ...
    public void onCreateProcess()
    {
		...
		if(!initiate())
		{
			Toast.makeText(mainContext, "bluebooth tarted",
		...
		.setTitle("BLE Device Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which)
			{
		        ...
		        if(device.getName()==null || device.getAddress()==null)
		        {
					...
					Log.e("ble", "onListItemClick " + device.getName().toString());

					Log.e("ble", "Device Name:"+device.getName() + "   " + "Device Name:" + device.getAddress());

					mDeviceName=device.getName().toString();
					mDeviceAddress=device.getAddress().toString();
					Intent service = new Intent(BlunoLibrary.this, ServiceFloating.class);
					service.putExtra("DeviceAddress", mDeviceAddress);
